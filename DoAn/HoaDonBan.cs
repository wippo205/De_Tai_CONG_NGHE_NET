...
namespace DoAn
{
    public partial class HoaDonBan : Form
    {
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            tong = Convert.ToDouble(Functions.GetFieldValues("SELECT TongTien FROM HDBan WHERE MaHDBan = N'" + txtMaHDBan.Text + "'"));
        ...
        private void btnInHoaDon_Click(object sender, EventArgs e)
        {
            ...
            sql = "SELECT a.MaHDBan, a.NgayBan, a.TongTien, b.TenKhach, b.DiaChi, b.DienThoai, c.TenNhanVien FROM HDBan AS a, Khach AS b, NhanVien AS c WHERE a.MaHDBan = N'" + txtMaHDBan.Text + "' AND a.MaKhach = b.MaKhach AND a.MaNhanVien = c.MaNhanVien";
        ...
        {
            Functions.FillCombo("SELECT MaHDBan FROM HDBan", cboMaHDBan, "MaHDBan", "MaHDBan");
            cboMaHDBan.SelectedIndex = -1;
        }
