...
namespace DoAn
{
    public partial class Hang : Form
    {
        ...
        private void dgvHang_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            MaSanPham = dgvHang.CurrentRow.Cells["MaSanPham"].Value.ToString();
            sql = "SELECT TenSanPham FROM SanPham WHERE MaSanPham=N'" + MaSanPham + "'";
            ...
            sql = "SELECT Img FROM Hang WHERE MaHang=N'" + txtMaHang.Text + "'";
            txtAnh.Text = Functions.GetFieldValues(sql);
            picAnh.Image = Image.FromFile(txtAnh.Text);
            sql = "SELECT ChuThich FROM Hang WHERE MaHang = N'" + txtMaHang.Text + "'";
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            sql = "INSERT INTO Hang(MaHang,TenHang,MaSanPham,SoLuong,DonGiaNhap, DonGiaBan,Img,ChuThich) VALUES(N'"
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            sql = "UPDATE Hang SET TenHang=N'" + txtTenHang.Text.Trim().ToString() +
                "',MaSanPham=N'" + cboMaSanPham.SelectedValue.ToString() +
                "',SoLuong=" + txtSoLuong.Text +
                ", DonGiaNhap=" + txtDonGiaNhap.Text +
                ", DonGiaBan=" + txtDonGiaBan.Text +
                ",Img='" + txtAnh.Text + "',ChuThich=N'" + txtGhichu.Text + "' WHERE MaHang=N'" + txtMaHang.Text + "'";
            Functions.RunSQL(sql);
            LoadDataGridView();
            ResetValues();
            btnBoQua.Enabled = false;
        ...
        {
            string sql;
            if ((txtMaHang.Text == "") && (txtTenHang.Text == "") && (cboMaSanPham.Text == ""))
            {
            ...
            if (cboMaSanPham.Text != "")
                sql += " AND MaSanPham LIKE N'%" + cboMaSanPham.SelectedValue + "%'";
            tblH = Functions.GetDataToTable(sql);
            if (tblH.Rows.Count == 0)
        ...
        {
            string sql;
            sql = "SELECT MaHang,TenHang,MaSanPham,SoLuong,DonGiaNhap,DonGiaBan,Img,ChuThich FROM Hang";
            tblH = Functions.GetDataToTable(sql);
            dgvHang.DataSource = tblH;
        }
